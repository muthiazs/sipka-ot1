      ...
      <div className="container mx-auto grid max-w-screen-xl items-center gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-16">
        <div className="space-y-6 text-center lg:text-left">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl text-foreground">
            SIPKA OT: <span className="text-primary">Kemandirian Anak</span> Melalui Terapi Alam
          </h1>
          <p className="text-lg text-muted-foreground md:text-xl">
            Platform inovatif yang mendukung tumbuh kembang anak berkebutuhan khusus dengan pendekatan terapi berbasis alam dan teknologi yang ramah pengguna.
          </p>
